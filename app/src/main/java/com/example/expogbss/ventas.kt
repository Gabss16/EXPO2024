...
class ventas : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val salir = findViewById<ImageButton>(R.id.salir8)
        salir.setOnClickListener{
            val intent = Intent(this, HomeFragment::class.java)
            startActivity(intent)
        }
        val rcvTrabajosPublicados = findViewById<RecyclerView>(R.id.rcvVentasServicioCliente)
        ...
        fun obtenerDatos(): List<Trabajo> {
            ...
            val resultSet = statement?.executeQuery("SELECT * FROM TRABAJO WHERE IdAreaDeTrabajo = 9")!!
